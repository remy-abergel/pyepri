...
# ----------------------------------
#
# We load the ``scd-inkjet-20141204`` dataset (embedded with the
...
path_proj = datasets.get_path('scd-inkjet-20141204-proj.pkl') # or use your own dataset, e.g., path_proj = '~/my_projections.DSC'
path_h = datasets.get_path('scd-inkjet-20141204-h.pkl') # or use your own dataset, e.g., path_h = '~/my_spectrum.DSC'
...
out_shape = (150, 300) # output image shape (number of pixels along each axes)
lbda = 50. # regularity parameter (arbitrary unit)
...
figsize=(6.4, 3.5) # size (width and height in inches) of the displayed figure
