...
# ----------------------------------
#
# We load the ``beads-thintubes-20081017`` dataset (embedded with the PyEPRI
...
frequency_cutoff = .2 # frequency cutoff to apply to the projections (here, keep only 20% of 
