...
# ----------------------------------
#
# We load the ``phalanx-20220203`` dataset (embedded with the PyEPRI
...
# ---------------------- #
dtype = 'float32'
path_proj = datasets.get_path('phalanx-20220203-proj.pkl') # or use your own dataset, e.g., path_proj = '~/my_projections.DSC'
path_h = datasets.get_path('phalanx-20220203-h.pkl') # or use your own dataset, e.g., path_h = '~/my_spectrum.DSC'
...
# ------------------------ #
delta = 8e-3; # sampling step in the same length unit as the provided field gradient coordinates (here cm)
out_shape = (400, 200) # output image shape (number of pixels along each axes)
...
figsize=(3.2, 4.8) # size (width and height in inches) of the displayed figure
