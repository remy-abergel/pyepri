...
# ----------------------------------
#
# We load the ``beads-phantom-20080313`` dataset (embedded with the PyEPRI
...
# ---------------------- #
dtype = 'float32'
path_proj = datasets.get_path('beads-phantom-20080313-proj.pkl') # or use your own dataset, e.g., path_proj = '~/my_projections.DSC'
path_h = datasets.get_path('beads-phantom-20080313-h.pkl') # or use your own dataset, e.g., path_h = '~/my_spectrum.DSC'
...
out_shape = (60, 180) # output image shape (number of pixels along each axes)
...
frequency_cutoff = .07 # frequency cutoff to apply to the projections (here, keep only 7% of 
...
figsize=(6.4, 2.9) # size (width and height in inches) of the displayed figure
