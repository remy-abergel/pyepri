...
# ----------------------------------
#
# We load the ``bacteria-inkjet-20100709`` dataset (embedded with the
...
# ---------------------- #
dtype = 'float32'
path_proj = datasets.get_path('bacteria-inkjet-20100709-proj.pkl') # or use your own dataset, e.g., path_proj = '~/my_projections.DSC'
path_h = datasets.get_path('bacteria-inkjet-20100709-h.pkl') # or use your own dataset, e.g., path_h = '~/my_spectrum.DSC'
...
out_shape = (100, 250) # output image shape (number of pixels along each axes)
...
frequency_cutoff = .25 # frequency cutoff to apply to the projections (here, keep only 25% of 
...
figsize=(6.4, 2.9) # figure size (width and height in inches)
